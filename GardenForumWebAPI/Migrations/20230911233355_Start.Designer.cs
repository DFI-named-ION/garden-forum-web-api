...
namespace GardenForumWebAPI.Migrations
{
    ...
    [Migration("20230911233355_Start")]
    partial class Start
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GardenForumWebAPI.Models.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GardenForumWebAPI.Models.CommentLike", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("comment_likes_id_primary");
            ...
            modelBuilder.Entity("GardenForumWebAPI.Models.Comment", b =>
                {
                    b.HasOne("GardenForumWebAPI.Models.User", "Author")
                        .WithMany("Comments")
                        .HasForeignKey("AuthorId")
                        .HasConstraintName("comments_author_id_foreign");
            ...
            modelBuilder.Entity("GardenForumWebAPI.Models.CommentLike", b =>
                {
                    b.HasOne("GardenForumWebAPI.Models.Comment", "Comment")
                        .WithMany("CommentLikes")
                        .HasForeignKey("CommentId")
                        .IsRequired()
                        .HasConstraintName("comment_likes_comment_id_foreign");

                    b.HasOne("GardenForumWebAPI.Models.User", "User")
                        .WithMany("CommentLikes")
                        .HasForeignKey("UserId")
                        .HasConstraintName("comment_likes_user_id_foreign");
